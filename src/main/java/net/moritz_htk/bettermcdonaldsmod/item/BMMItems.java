...
public class BMMItems {
    ...
    public static final RegistryObject<Item> FILET_O_FISH = ITEMS.register("filet_o_fish", () -> new Item(new Item.Properties().food(registerFoodValues(8, 4f).build())));
    public static final RegistryObject<Item> MCWRAP = ITEMS.register("mcwrap", () -> new Item(new Item.Properties().food(registerFoodValues(7, 3.5f).build())));
    public static final RegistryObject<Item> CHICKEN_MCNUGGETS = ITEMS.register("chicken_mcnuggets", () -> new Item(new Item.Properties().food(registerFoodValues(6, 3f).build())));
    public static final RegistryObject<Item> FRIES = ITEMS.register("fries", () -> new Item(new Item.Properties().food(registerFoodValues(4, 2f).build())));
    ...
    public static final RegistryObject<Item> COCA_COLA = ITEMS.register("coca_cola", () -> new DrinkItem(new Item.Properties().food(registerFoodValues(4, 2f).build())));
    public static final RegistryObject<Item> FANTA = ITEMS.register("fanta", () -> new DrinkItem(new Item.Properties().food(registerFoodValues(4, 2f).build())));
    public static final RegistryObject<Item> SPRITE = ITEMS.register("sprite", () -> new DrinkItem(new Item.Properties().food(registerFoodValues(4, 2f).build())));
